...
export const createDocumentRequest = async (document) => axios.post("/documents", document);

export const updateDocumentRequest = async (id, document) => axios.put(`/documents/${id}`, document); 
